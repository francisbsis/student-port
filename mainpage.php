...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="Student.php">Information of Students</a> </li>
    ...
    <main>
        <section>
            ...
            <p>𝙏𝙝𝙚 𝙈𝙞𝙜𝙝𝙩𝙮 𝙎𝙏𝙀𝙈 𝘾𝙝𝙤𝙣𝙙𝙧𝙞𝙖 is hosting a meeting right at the moment.</p>
        </section>
        <section>
            <h2>Upcoming Events</h2>
            <p>Nature Walk New Episodes is coming this week!!.</p>
        </section>
    </main>
    <footer>
        <br>
